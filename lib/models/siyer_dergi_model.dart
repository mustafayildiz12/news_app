...
//
//     final siyerResponse = siyerResponseFromJson(jsonString);

import 'dart:convert';

List<SiyerResponse> siyerResponseFromJson(String str) =>
    List<SiyerResponse>.from(
        json.decode(str).map((x) => SiyerResponse.fromJson(x)));

String siyerResponseToJson(List<SiyerResponse> data) =>
...
class SiyerResponse {
  ...
  factory SiyerResponse.fromJson(Map<String, dynamic> json) => SiyerResponse(
        id: json["id"],
...
enum Taxonomy { CATEGORY, POST_TAG, POWERKIT_POST_FEATURED }

final taxonomyValues = EnumValues({
  "category": Taxonomy.CATEGORY,
  "post_tag": Taxonomy.POST_TAG,
  "powerkit_post_featured": Taxonomy.POWERKIT_POST_FEATURED
});
